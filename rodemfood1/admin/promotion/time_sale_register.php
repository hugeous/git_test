...
<form id="frmGoods" name="frmGoods"  target ="ifrmProcess" action="./time_sale_ps.php" method="post"
    ...
    <table class="table table-cols">
        ...
        <tr>
            ...
            <td class="input_area" colspan="3">
                <div class="form-inline">
                    <label class="radio-inline"><input type="radio" name="mainDisplayFl" value="y"  <?=gd_isset($checked['mainDisplayFl']['y']);?>>노출</label>
                    <label class="radio-inline"><input type="radio" name="mainDisplayFl" value="n"  <?=gd_isset($checked['mainDisplayFl']['n']);?>>비노출</label>
                </div>
            </td>
        </tr>
        <tr>
